...
namespace XGMESMain.LogWS {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="WSLogSoap", Namespace="http://tempuri.org/")]
    public partial class WSLog : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public WSLog() {
            this.Url = global::XGMESMain.Properties.Settings.Default.XGMESMain_LogWS_WSLog;
        ...
        public string Log(string ip, string clientCount, string type, string timeCount, string account) {
        ...
        /// <remarks/>
        public void LogAsync(string ip, string clientCount, string type, string timeCount, string account) {
            this.LogAsync(ip, clientCount, type, timeCount, account, null);
        }
        
        /// <remarks/>
        public void LogAsync(string ip, string clientCount, string type, string timeCount, string account, object userState) {
            ...
            this.InvokeAsync("Log", new object[] {
                        ...
                        type,
                        timeCount,
                        account}, this.LogOperationCompleted, userState);
        }
